...
### 🔄 [Transformers](https://github.com/Uszkido/transformers)
State-of-the-art transformer architectures for NLP, vision, and multimodal intelligence.

</td>
<td width="33%">

### 📖 [Quran Verse Detection](https://github.com/Uszkido/quran-verse-detection)
AI-powered Arabic text recognition and verse classification system.

</td>
<td width="33%">

### 🗣️ [Hausa NLP](https://github.com/Uszkido/Awesome-HausaNLP)
Pioneering NLP resources for the Hausa language — advancing African language AI.
...
### 📖 [Hadith API](https://github.com/Uszkido/hadith-api)
RESTful API for authentic Hadith collections.

</td>
<td width="25%">

### 📚 [Hadith JSON](https://github.com/Uszkido/hadith-json)
Structured JSON database of verified Hadith.

</td>
<td width="25%">

### 🕋 [Quran API](https://github.com/Uszkido/quran-api)
Complete Quran API with translations and tafsir.

</td>
<td width="25%">

### 📜 [Islamic APIs](https://github.com/Uszkido/Islamic-APIs)
Unified collection of Islamic scholarly APIs.
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Uszkido/Uszkido/output/profile-night-view.svg" alt="Vexel Innovations 2D Activity Graph" width="100%"/>
</p>
